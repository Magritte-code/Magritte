...
modeldir= "/lhome/thomasc/github/Magritte/tests/models/"
datadir = "/lhome/thomasc/github/Magritte/tests/data"
model_file = os.path.join(modeldir, 'model_Phantom_3D.hdf5' )   # Resulting Magritte model
redux_file = os.path.join(modeldir, 'model_Phantom_3D_red' )   # Reduced Magritte model (no extension!)
