...
The following examples show how Magritte can be used to post-process snapshots of
hydrodynamics simulations. We consider snapshots of both `MPI-AMRVAC
<http://amrvac.org/>`_, a solver based on adaptive mesh refinement (AMR, `Xia et al. 2018
...
how these models can be reduced to smaller approximate models for fast radiative transfer
