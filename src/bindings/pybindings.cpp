...
PYBIND11_MODULE (core, module)
{
    ...
    py::class_<Parameters, std::shared_ptr<Parameters>> (module, "Parameters", "Class containing the model parameters.")
        ...
        .def_readwrite ("use_adaptive_Ng_acceleration", &Parameters::use_adaptive_Ng_acceleration, "Whether to use adaptive Ng acceleration.")
        .def_readwrite ("Ng_acceleration_mem_limit", &Parameters::Ng_acceleration_mem_limit, "Memory limit for ng acceleration.")
        .def_readwrite ("adaptive_Ng_acceleration_use_max_criterion", &Parameters::adaptive_Ng_acceleration_use_max_criterion, "Whether of not to use the maximum relative change as criterion for the adaptive ng-acceleration")
        .def_readwrite ("Ng_acceleration_remove_N_its", &Parameters::Ng_acceleration_remove_N_its, "Number of iterations to ignore when using ng-acceleration")
        .def_readwrite ("adaptive_Ng_acceleration_min_order", &Parameters::adaptive_Ng_acceleration_min_order, "Minimal order of ng acceleration when using adaptive Ng acceleration. Has to be larger than 1.")
        // setters
