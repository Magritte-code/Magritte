...
PYBIND11_MODULE (core, module)
{
    ...
    py::class_<Parameters, std::shared_ptr<Parameters>> (module, "Parameters", "Class containing the model parameters.")
        ...
        .def_readwrite ("Ng_acceleration_mem_limit", &Parameters::Ng_acceleration_mem_limit, "Memory limit for adaptive ng acceleration.")
        ...
        .def_readwrite ("Ng_acceleration_remove_N_its", &Parameters::Ng_acceleration_remove_N_its, "Number of iterations to ignore when using adaptive ng-acceleration")
        // setters
