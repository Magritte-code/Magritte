...
PYBIND11_MODULE (core, module)
{
    ...
    py::class_<Parameters, std::shared_ptr<Parameters>> (module, "Parameters", "Class containing the model parameters.")
        ...
        .def_readwrite ("min_dtau",                    &Parameters::min_dtau                   , "Minimum absolute optical depth increment that will be assumed in the solver.")
        .def_readwrite ("min_negative_dtau",           &Parameters::min_negative_dtau          , "Minimum negative optical depth increment that will be assumed in the solver.")
