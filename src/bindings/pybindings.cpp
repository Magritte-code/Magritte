...
PYBIND11_MODULE (core, module)
{
    ...
    py::class_<Model> (module, "Model")
        ...
        .def_readwrite ("using_same_grid",&Model::using_same_grid)
        .def_readwrite ("COMPUTING_SVD_AND_CONDITION_NUMBER", &Model::COMPUTING_SVD_AND_CONDITION_NUMBER)
        ...
        .def ("compute_radiation_field_collocation",                                &Model::compute_radiation_field_collocation)
        ...
        .def ("compute_level_populations_collocation",                              &Model::compute_level_populations_collocation)
        .def ("compute_level_populations_multiresolution",                          &Model::compute_level_populations_multiresolution)
        ...
        .def ("setup_multiresolution",                                              &Model::setup_multiresolution)
    ...
    py::class_<Multiscale> (module, "Multiscale")
        ...
        .def("get_all_neighbors_as_vector", (Size1 (Multiscale::*)(const Size) const) &Multiscale::get_all_neighbors_as_vector)
        .def("get_all_neighbors_as_vector", (Size1 (Multiscale::*)() const) &Multiscale::get_all_neighbors_as_vector)
        .def("get_all_n_neighbors", (Size1 (Multiscale::*)(const Size) const) &Multiscale::get_all_n_neighbors)
        .def("get_all_n_neighbors", (Size1 (Multiscale::*)() const) &Multiscale::get_all_n_neighbors)
