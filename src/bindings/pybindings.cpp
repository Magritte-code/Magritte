...
PYBIND11_MODULE (core, module)
{
    ...
    py::class_<Parameters> (module, "Parameters", "Class containing the model parameters.")
        ...
        .def ("set_memory_optimisation_stat_eq",&Parameters::set_memory_optimisation_stat_eq, "Set whether or not to use the memory optimization for computing the static equilibrium equations.")
        ...
        .def ("memory_optimisation_stat_eq",  &Parameters::memory_optimisation_stat_eq, "Whether or not to use the memory optimization for computing the static equilibrium equations.")
