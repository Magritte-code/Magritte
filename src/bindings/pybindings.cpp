...
PYBIND11_MODULE(core, module) {
    ...
    py::class_<Model>(module, "Model", "Class containing the Magritte model.")
        ...
        .def("compute_radiation_field_comoving", &Model::compute_radiation_field_comoving,
            "Compute the radiation field for the model using the 2th-order comoving method.")
        .def("compute_radiation_field_comoving_local_approx",
            &Model::compute_radiation_field_comoving_local_approx,
            "Compute the radiation field for the model using the 2th-order comoving method and a "
        ...
        .def("compute_level_populations_comoving", &Model::compute_level_populations_comoving,
            "Compute the level populations for the model assuming statistical equilibrium until "
            "convergence, using a comoving type method. This optionally use Ng-acceleration and "
            "iterates maximally for the given maximum number of iterations. (Memory sparse "
            "option.)")
        .def("compute_level_populations_comoving_local_approx",
        ...
        .def("compute_image_new_shortchar",
            (int(Model::*)(const Size ray_nr, const Size Nxpix, const Size Nypix))
                & Model::compute_image_new_shortchar,
            "Compute an image of the model along the given ray direction, using "
            "the new imager, specifying the image resolution.")
        .def("compute_image_new_shortchar",
            (int(Model::*)(const double rx, const double ry, const double rz, const Size Nxpix,
