...
/// Moved to solver as part of post-processing the solver results
...
//                 const Real line_absorption =  opacity (p, lid) * lineProducingSpecies[l].Jlin(p, k);
//
...
/// Might be implemented somewhere else later; but not here
