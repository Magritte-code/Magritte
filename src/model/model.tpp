...
//     for (Size levidx=0; levidx<parameters.nlev(); levidx++)
//     {
//       Eigen::Vector<T,Eigen::Dynamic> right_hand_side(nb_neighbors_coarser_grid);
//       for (Size idx=0; idx<nb_neighbors_coarser_grid; idx++)
//       {
...
//         right_hand_side(idx)=lines.lineProducingSpecies.get_level_pop(neighbors_coarser_grid[idx],levidx);
//       }
...
//       lines.lineProducingSpecies.set_level_pop(diff_point,levidx,abs(interpolated_value));
