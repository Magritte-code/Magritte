...
struct Frequencies {
    ...
    Bool1 appears_in_line_integral; ///< True if the frequency appears in line
                                    ///< integral
    Size1 corresponding_l_for_spec; ///< number of line species corresponding to
                                    ///< frequency
    Size1 corresponding_k_for_tran; ///< number of transition corresponding to
                                    ///< frequency
    Size1 corresponding_z_for_line; ///< number of line number corresponding to
                                    ///< frequency
