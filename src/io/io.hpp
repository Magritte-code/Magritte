...
struct Io {
    ...
    // virtual int  read_list     (const string fname,       Double1 &list  )
    // const = 0; virtual int write_list     (const string fname, const Double1
    // &list  ) const = 0;
    ...
    // virtual int  read_array    (const string fname,       Double2 &array )
    // const = 0; virtual int write_array    (const string fname, const Double2
    // &array ) const = 0;
