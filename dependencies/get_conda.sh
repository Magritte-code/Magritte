...
case "`uname -s`" in
    Linux*)
        ...
        #wget https://repo.anaconda.com/miniconda/Miniconda3-py38_4.10.3-Linux-x86_64.sh -O miniconda3.sh
    ;;
    Darwin*)
        ...
        #wget https://repo.anaconda.com/miniconda/Miniconda3-py38_4.10.3-MacOSX-x86_64.sh -O miniconda3.sh
    ;;
    *)
